...
export var wallSound = new soundFile("ballhitwall.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("hitball.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("scorepoint2.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("Galaxy.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -20; //turn down volume

export var adventureMusic = new soundFile("Galaxy.mp3");
